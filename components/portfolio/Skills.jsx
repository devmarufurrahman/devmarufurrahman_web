    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="h-1.5 w-24 mx-auto bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-full shadow-[0_0_15px_rgba(168,85,247,0.4)]" />
          <p className="mt-6 text-slate-400 font-medium max-w-2xl mx-auto italic">
            আমার ৩ বছরের অভিজ্ঞতায় অর্জন করা টেকনিক্যাল স্কিল এবং টুলস যা দিয়ে
            আমি হাই-পারফরম্যান্স মোবাইল অ্যাপ তৈরি করি।
          </p>
        </motion.div>
